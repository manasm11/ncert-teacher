            ...
            <div className="w-full max-w-md bg-white/80 backdrop-blur-xl p-8 rounded-3xl shadow-xl shadow-black/5 border border-white relative z-10">
                ...
                <div className="space-y-3 mb-6">
                    <button
                        ...
                        className="w-full py-3 px-4 bg-white border border-border rounded-xl hover:bg-muted/50 transition-all flex items-center justify-center gap-3 text-sm font-medium text-foreground"
                    >
                    ...
                    <button
                        ...
                        className="w-full py-3 px-4 bg-foreground text-background border border-foreground rounded-xl hover:opacity-90 transition-all flex items-center justify-center gap-3 text-sm font-medium"
                    >
